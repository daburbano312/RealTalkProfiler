...
VokaturiVoice VokaturiVoice_create (
	...
	int buffer_length,   // e.g. 441000 for a 10-second buffer
	int multi_threading   // 1 if fill() and extract() can be in separate threads, 0 if not
);
